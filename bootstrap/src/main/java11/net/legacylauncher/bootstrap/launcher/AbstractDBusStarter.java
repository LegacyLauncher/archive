...
public abstract class AbstractDBusStarter extends AbstractStarter implements Closeable {
    ...
    public static BusAddress createDynamicSession(boolean listeningAddress) {
        String busAddress;
    ...
    protected Future<Void> prepareDBusServer() {
        ...
        getExecutorService().submit(() -> {
            try {
                ...
                builder.transportConfig().withListening(true).withPreConnectCallback((transport) -> serverAccepting.complete(null));
