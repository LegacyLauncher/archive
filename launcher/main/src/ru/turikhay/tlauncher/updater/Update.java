...
public class Update {
    ...
    public boolean isRequired() {
        return version != null && (TLauncher.isBeta() || (version.greaterThan(TLauncher.getVersion()) && version.getMinorVersion() > TLauncher.getVersion().getMinorVersion()));
    }
    ...
    protected void apply0() throws Throwable {
        ...
        String[] args = TLauncher.getInstance() != null ? TLauncher.getInstance().getOptions().getArgs() : new String[0];
            ...
            if (description != null) {
                if (!TLauncher.getBrand().equals("Legacy") && description.containsKey("en_US")) {
                    ...
                    for (String locale : Static.getLangList()) {
                        ...
                        description.put(locale, universalDescription);
                    }
                } else {
