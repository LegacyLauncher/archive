...
import net.legacylauncher.managers.MemoryAllocationService.Hint;
import net.legacylauncher.managers.MemoryAllocationService.MemoryInfo;
import net.legacylauncher.managers.MemoryAllocationService.OsInfo;
import net.legacylauncher.managers.MemoryAllocationService.VersionContext;
...
import static net.legacylauncher.managers.MemoryAllocationService.DEFAULT_BASE_REQUIREMENT;
