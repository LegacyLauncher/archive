...
public class MemorySlider extends ExtendedPanel implements EditorField, LocalizableComponent {
    ...
    private final Lazy<net.legacylauncher.ui.images.ImageIcon> questionIcon = Images.getIcon16Lazy("question");
...
//                    Optional.of((CompleteVersion) availableVersion) : Optional.empty();
            ...
            Future<MemoryAllocationService.Hint> hintFuture = service.queryHint(new MemoryAllocationService.VersionContext(
                    availableVersion,
                    null
//                    completeVersion
...
//                            .orElse(null)
            ...
            final MemoryAllocationService.Hint _hint = hint;
