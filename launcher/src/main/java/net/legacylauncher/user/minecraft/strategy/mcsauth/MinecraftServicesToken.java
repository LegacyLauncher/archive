...
import net.legacylauncher.user.minecraft.strategy.rqnpr.Validatable;

import java.time.Instant;

import static net.legacylauncher.user.minecraft.strategy.rqnpr.Validatable.notEmpty;
import static net.legacylauncher.user.minecraft.strategy.rqnpr.Validatable.notNegative;
