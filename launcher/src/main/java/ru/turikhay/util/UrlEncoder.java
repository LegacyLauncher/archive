...
public class UrlEncoder {
    ...
    public UrlEncoder(CharSequence sequence, boolean ignoreSpace) {
        this.s = U.requireNotNull(sequence);
        this.ignoreSpace = ignoreSpace;
    }

    public UrlEncoder(CharSequence sequence) {
        this(sequence, IGNORE_SPACE);
    }

    public Encoder getEncoder(boolean ignoreSpace) {
        return new Encoder();
    }

    public Encoder getEncoder() {
        return getEncoder(IGNORE_SPACE);
    }
    ...
    public static String encode(String str, boolean ignoreSpace) {
        return new UrlEncoder(str, ignoreSpace).encode();
    }

    public static String encode(String str) {
        return encode(str, IGNORE_SPACE);
    }
}
