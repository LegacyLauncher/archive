...
public class VersionSyncInfo {
   ...
   public Version getLatestVersion() {
      switch($SWITCH_TABLE$net$minecraft$launcher$versions$VersionSource()[this.getLatestSource().ordinal()]) {
      case 1:
         return this.localVersion;
      case 2:
         return this.remoteVersion;
   ...
   public String toString() {
      return "VersionSyncInfo{localVersion=" + this.localVersion + ", remoteVersion=" + this.remoteVersion + ", extraVersion=" + this.extraVersion + ", isInstalled=" + this.isInstalled + ", isUpToDate=" + this.isUpToDate + '}';
   }
