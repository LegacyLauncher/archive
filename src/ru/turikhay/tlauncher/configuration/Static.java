...
public final class Static {
   private static final String[] UPDATE_REPO = new String[]{"http://cdn.turikhay.ru/update.json.gzip", "http://u.tlauncher.ru/update/", "http://turikhay.1gb.ru/update.json", "http://tlaun.ch/update/legacy.json"};
   private static final String[] OFFICIAL_REPO = new String[]{"http://s3.amazonaws.com/Minecraft.Download/"};
   private static final String[] EXTRA_REPO = (String[])U.shuffle(new String[]{"http://u.tlauncher.ru/repo/", "http://turikhay.1gb.ru/repo/", "http://turikhay.ru/tlauncher/repo/"});
