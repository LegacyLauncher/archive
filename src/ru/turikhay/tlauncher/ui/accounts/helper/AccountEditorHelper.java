...
public class AccountEditorHelper extends ExtendedLayeredPane {
	...
	public AccountEditorHelper(AccountEditorScene scene) {
		...
		this.tips = new HelperTip[] {
				new HelperTip("add", handler.list.add, handler.list, DOWN,
						HelperState.PREMIUM, HelperState.FREE),
				new HelperTip("username", handler.editor.username,
						handler.editor, LEFT, HelperState.PREMIUM,
						HelperState.FREE),
				new HelperTip("checkbox", handler.editor.premiumBox,
						handler.editor, LEFT, HelperState.PREMIUM,
						HelperState.FREE),
				new HelperTip("password", handler.editor.password,
						handler.editor, LEFT, HelperState.PREMIUM),
				new HelperTip("button", handler.editor.save, handler.editor,
						LEFT, HelperState.PREMIUM, HelperState.FREE),
				new HelperTip("exit", handler.list.back, handler.list, RIGHT,
						HelperState.PREMIUM, HelperState.FREE),
				new HelperTip("help", handler.list.help, handler.list, DOWN,
						HelperState.HELP) };
