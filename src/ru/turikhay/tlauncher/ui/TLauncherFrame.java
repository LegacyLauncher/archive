...
public class TLauncherFrame extends JFrame {
	public static final Dimension minSize = new Dimension(530, 530), maxSize = new Dimension(1920, 1080);
	...
	public void updateTitle() {
		...
		//copyright = "by " + TLauncher.getDeveloper() + (translator != null ? ", translated by "+ translator : "");

		brand = TLauncher.getBrand() + " " + TLauncher.getVersion() + (TLauncher.isBeta()? " BETA" : "");
	}
