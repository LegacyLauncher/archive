...
import com.turikhay.tlauncher.ui.login.buttons.ButtonPanel.ButtonPanelState;
...
public class AutoLogin implements LoginListener {
	...
	public final static int MIN_TIMEOUT = 2, MAX_TIMEOUT = 10;
	...
	AutoLogin(LoginForm lf){
		...
		if(timeout < MIN_TIMEOUT || timeout > MAX_TIMEOUT) timeout = DEFAULT_TIMEOUT;
