...
public class AccountEditorHelper extends ExtendedLayeredPane {
	...
	public AccountEditorHelper(AccountEditorScene scene) {
		...
		this.steps = new HelperStep[] {
				...
				new HelperStep("username", handler.editor.username,
						handler.editor, LEFT, HelperState.LICENSE,
						HelperState.PIRATE),
				new HelperStep("checkbox", handler.editor.premiumBox,
						handler.editor, LEFT, HelperState.LICENSE,
						HelperState.PIRATE),
				new HelperStep("password", handler.editor.password,
						handler.editor, LEFT, HelperState.LICENSE),
				new HelperStep("button", handler.editor.save, handler.editor,
						LEFT, HelperState.LICENSE, HelperState.PIRATE),
