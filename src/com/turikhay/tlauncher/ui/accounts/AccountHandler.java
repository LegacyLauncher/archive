...
public class AccountHandler {
	...
	public void selectAccount(Account acc){
		if(acc == null) return;
		if(acc.equals(list.list.getSelectedValue())) return;
	...
	void registerTemp(){		
		...
		scene.getMainPane().defaultScene.loginForm.accounts.refreshAccounts(manager.getAuthDatabase(), tempAccount.getUsername());
