...
public class ProgressBar extends JProgressBar implements LocalizableComponent {
	...
	private void paint_(Graphics g){
		...
		if(center) g2D.drawString(center_string, center_x, center_y);
		if(west) g2D.drawString(west_string, west_x, west_y);
		if(east) g2D.drawString(east_string, east_x, east_y);
	...
	public void updateLocale() { repaint(); }
