...
public class ExtendedTextField extends JTextField {	
	...
	/**
	 * This method shouldn't be used to get an pointful value of current <code>JTextField</code> because it
	 * may return placeholder or empty string.
	...
	/**
	 * This method is called to get an pointful value of any <code>String</code> for current <code>JTextField</code>
	 * @param value
	 * @return pointful value of <value>String</code>
	 */
	private String getValueOf(String value){
		if(value == null || value.isEmpty() || value.equals(placeholder) || value.equals(oldPlaceholder))
			return null;
	...
	/**
	 * This method is called to get an pointful value of the <code>JTextField</code>
	 ...
	 * 
	 * @param obj Object to be set as text
	 */
