...
/**
 * <code>InvalidateTextField</code> is non-abstract implementation of <code>CheckableTextField</code>
 * that can't be set invalid by itself. This can be used to implement more complicated validity check.
 * 
 * @author Artur Khusainov
 * @see com.turikhay.tlauncher.ui.settings.ResolutionField
 * @see com.turikhay.tlauncher.ui.console.SearchField
 *
 */
