...
public class AccountCellRenderer implements ListCellRenderer<Account> {
	...
	public static final Icon
		MANAGE_ICON = new ImageIcon(ImageCache.getImage("gear.png")),
		CROWN_ICON = new ImageIcon(ImageCache.getImage("crown.png"));
	...
	public Component getListCellRendererComponent(
		...
		if(value == null ||value.equals(EMPTY))
			...
			switch(type){
			case EDITOR:
				if(value.hasLicense()) renderer.setIcon(CROWN_ICON);
