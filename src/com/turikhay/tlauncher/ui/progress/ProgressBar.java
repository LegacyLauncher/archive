...
public class ProgressBar extends JProgressBar {
	...
	// Arrays containing bounds of strings: zero elem: x, 1th: text width, 2nd: text height (and y);
	...
	public void setStrings(String west, String center, String east, boolean acceptNull, boolean repaint){
		if(acceptNull || west != null) this.setWestString(west, false);
		if(acceptNull || center != null) this.setCenterString(center, false);
		if(acceptNull || east != null) this.setEastString(east, false);
	...
	public void setWestString(String string, boolean update){
		...
		if(wS_changed && update) this.repaint();
	}
	...
	public void setCenterString(String string, boolean update){
		...
		if(cS_changed && update) this.repaint();
	}
	...
	public void setEastString(String string, boolean update){
		...
		if(eS_changed && update) this.repaint();
	}
	...
	public void clearProgress(){
		...
		this.setValue(0);
		this.setStrings(null, null, null, false, false);
	}
	...
	private void draw(Graphics g){		
		...
		if(!(drawWest || drawCenter || drawEast)) return; // Nothing to draw.
