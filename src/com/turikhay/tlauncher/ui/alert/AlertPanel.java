...
class AlertPanel extends JPanel {
	...
	AlertPanel(String message, Object textarea) {
		...
		String textareaContent = textarea == null ? null : U.w(
				U.toLog(textarea), MAX_CHARS_ON_LINE), messageContent = message == null ? null
				: "<html>"
						+ U.w(message, MAX_CHARS_ON_LINE).replaceAll("\n",
								"<br/>") + "</html>";
