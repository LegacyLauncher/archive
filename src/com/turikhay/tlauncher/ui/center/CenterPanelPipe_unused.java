...
public class CenterPanelPipe_unused extends JComponent implements ResizeableComponent {
   ...
   private int pipeY;
   // $FF: synthetic field
   private static int[] $SWITCH_TABLE$com$turikhay$tlauncher$ui$center$CenterPanelPipe_unused$PipeOrientation;
   ...
   public void paintComponent(Graphics g0) {
      if (this.targetComponent != null && this.pipeOrientation != null) {
         ...
         switch($SWITCH_TABLE$com$turikhay$tlauncher$ui$center$CenterPanelPipe_unused$PipeOrientation()[this.pipeOrientation.ordinal()]) {
         case 1:
            triangleX[0] = maxX;
            triangleY[0] = 0;
            triangleX[1] = 0;
   ...
   // $FF: synthetic method
   static int[] $SWITCH_TABLE$com$turikhay$tlauncher$ui$center$CenterPanelPipe_unused$PipeOrientation() {
      int[] var10000 = $SWITCH_TABLE$com$turikhay$tlauncher$ui$center$CenterPanelPipe_unused$PipeOrientation;
      if (var10000 != null) {
         return var10000;
      } else {
         ...
         $SWITCH_TABLE$com$turikhay$tlauncher$ui$center$CenterPanelPipe_unused$PipeOrientation = var0;
         return var0;
      }
   }
