...
/**
 * An abstract <code>RefreshableComponent</code> whose refresh process can be cancelled.
 * 
...
public abstract class InterruptibleComponent extends RefreshableComponent {
	...
	/**
	 * Refreshes information and then flushes it if the <code>refreshID</code> is not set as stopped.
	 */
