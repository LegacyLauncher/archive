...
public class ProfileManager extends RefreshableComponent {
	public static final String
		DEFAULT_PROFILE_NAME = "TLauncher",
		DEFAULT_PROFILE_FILENAME = "launcher_profiles.json";
	...
	private void loadProfiles() {
		...
		try{
			raw = this.gson.fromJson(
				parser.parse(FileUtil.readFile(file)).getAsJsonObject(),
