...
public class ServerList {	
	...
	public static ServerList loadFromFile(File file) throws IOException {
        ...
        if(compound == null) return serverList;
	...
	public static class Server {
		...
		public static Server loadFromNBT(NBTTagCompound nbt){
			...
			if(nbt.hasKey("acceptTextures")) server.acceptTextures = nbt.getBoolean("acceptTextures")? 1 : -1;
		...
		public NBTTagCompound getNBT(){
			...
			if(acceptTextures != 0) compound.setBoolean("acceptTextures", acceptTextures == 1);
