...
public class Authenticator {
	...
	//private static final URL ROUTE_VALIDATE = Http.constantURL("https://authserver.mojang.com/validate");
	//private static final URL ROUTE_INVALIDATE = Http.constantURL("https://authserver.mojang.com/invalidate");
	//private static final URL ROUTE_SIGNOUT = Http.constantURL("https://authserver.mojang.com/signout");
	...
	public void pass() throws AuthenticatorException {
		...
		if(account.getPassword() == null) tokenLogin();
		else passwordLogin();
