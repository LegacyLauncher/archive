...
public class U {
	...
	public static String w(String string, int max, boolean rude){ return w(string, max, '\n', rude); }
	...
	private static String stackTrace0(Throwable e){
		...
		for(int x=0;x<elems.length;x++){
			...
			if(elem.startsWith("com.turikhay")) found_out++;
			if(found_out < 5 && x < 15) continue;
	...
	public static int getConnectionTimeout(){
		...
		if(quality == null) return DEFAULT_CONNECTION_TIMEOUT;
