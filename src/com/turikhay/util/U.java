...
public class U {
	public final static String PROGRAM_PACKAGE = "com.turikhay";
	...
	private static String w(String string, int normal, char newline,
			boolean rude) {
	...
	public static void gc() {
		log("Starting garbage collector: " + U.getUsingSpace() + " / "
				+ getTotalSpace() + " MB");
		System.gc();
		log("Garbage collector completed: " + U.getUsingSpace() + " / "
				+ getTotalSpace() + " MB");
	}
