...
public class ReversedLinesFileReader implements Closeable {
   ...
   public ReversedLinesFileReader(File file, int blockSize, Charset encoding) throws IOException {
      ...
      this.currentFilePart = new ReversedLinesFileReader.FilePart(this.totalBlockCount, lastBlockLength, (byte[])null, (ReversedLinesFileReader.FilePart)null);
   ...
   private class FilePart {
      ...
      private int getNewLineMatchByteCount(byte[] data, int i) {
         byte[][] var6;
         int var5 = (var6 = ReversedLinesFileReader.this.newLineSequences).length;

         for(int var4 = 0; var4 < var5; ++var4) {
            byte[] newLineSequence = var6[var4];
            boolean match = true;
      ...
      // $FF: synthetic method
      FilePart(long var2, int var4, byte[] var5, ReversedLinesFileReader.FilePart var6) throws IOException {
         this(var2, var4, var5);
      }
   }
}
