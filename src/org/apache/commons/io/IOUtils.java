...
public class IOUtils {
   ...
   public static void write(StringBuffer data, OutputStream output) throws IOException {
      write((StringBuffer)data, (OutputStream)output, (String)null);
   }
   ...
   public static void writeLines(Collection lines, String lineEnding, OutputStream output, Charset encoding) throws IOException {
      if (lines != null) {
         ...
         for(Iterator var6 = lines.iterator(); var6.hasNext(); output.write(lineEnding.getBytes(cs))) {
            Object line = var6.next();
            if (line != null) {
   ...
   public static void writeLines(Collection lines, String lineEnding, Writer writer) throws IOException {
      if (lines != null) {
         ...
         for(Iterator var4 = lines.iterator(); var4.hasNext(); writer.write(lineEnding)) {
            Object line = var4.next();
            if (line != null) {
